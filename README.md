...
- 구현한 내용 (위 그림 참조)
	...
	- 추가 옵션: CheckBox를 사용하여 감자튀김, 콜라, 치즈, 소스 추가 선택
...
- 구현한 내용 (위 그림 참조)
	- 에러 메시지: 메뉴를 선택하지 않고 주문하기 버튼을 클릭할 때 label을 사용하여 "메뉴를 선택하세요" 메시지 표시
...
- 구현한 내용 (위 그림 참조)
	- TabIndex 속성을 설정하여 메뉴 선택과 추가 옵션 사이를 Tab 키로 이동할 수 있도록 구현
...
![실행화면](img/screenshot4-2.png)

![실행화면](img/screenshot4-3.png)

![실행화면](img/screenshot4-4.png)
